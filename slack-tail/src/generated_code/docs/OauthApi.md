...
> ::std::collections::HashMap<String, serde_json::Value> oauth_access(code, token, redirect_uri, single_channel, client_id, client_secret)
...
> ::std::collections::HashMap<String, serde_json::Value> oauth_token(client_secret, code, single_channel, client_id, redirect_uri)
