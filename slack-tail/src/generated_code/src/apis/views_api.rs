...
pub async fn views_open(configuration: &configuration::Configuration, token: &str, trigger_id: &str, view: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ViewsOpenError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/views.open", configuration.base_path);
...
pub async fn views_publish(configuration: &configuration::Configuration, token: &str, user_id: &str, view: &str, hash: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ViewsPublishError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/views.publish", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn views_push(configuration: &configuration::Configuration, token: &str, trigger_id: &str, view: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ViewsPushError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/views.push", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn views_update(configuration: &configuration::Configuration, token: &str, hash: Option<&str>, view_id: Option<&str>, external_id: Option<&str>, view: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ViewsUpdateError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/views.update", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
