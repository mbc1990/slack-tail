...
pub async fn admin_apps_approve(configuration: &configuration::Configuration, token: &str, team_id: Option<&str>, app_id: Option<&str>, request_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminAppsApproveError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.apps.approve", configuration.base_path);
...
pub async fn admin_apps_approved_list(configuration: &configuration::Configuration, token: &str, cursor: Option<&str>, limit: Option<i32>, team_id: Option<&str>, enterprise_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminAppsApprovedListError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.apps.approved.list", configuration.base_path);
...
pub async fn admin_apps_requests_list(configuration: &configuration::Configuration, token: &str, cursor: Option<&str>, limit: Option<i32>, team_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminAppsRequestsListError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.apps.requests.list", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn admin_apps_restrict(configuration: &configuration::Configuration, token: &str, team_id: Option<&str>, app_id: Option<&str>, request_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminAppsRestrictError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.apps.restrict", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn admin_apps_restricted_list(configuration: &configuration::Configuration, token: &str, cursor: Option<&str>, limit: Option<i32>, team_id: Option<&str>, enterprise_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminAppsRestrictedListError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.apps.restricted.list", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
/// Add an emoji.
pub async fn admin_emoji_add(configuration: &configuration::Configuration, url: &str, token: &str, name: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminEmojiAddError>> {
...
/// Rename an emoji.
pub async fn admin_emoji_rename(configuration: &configuration::Configuration, new_name: &str, token: &str, name: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminEmojiRenameError>> {
...
pub async fn admin_invite_requests_approved_list(configuration: &configuration::Configuration, token: &str, cursor: Option<&str>, limit: Option<i32>, team_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminInviteRequestsApprovedListError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.inviteRequests.approved.list", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn admin_invite_requests_denied_list(configuration: &configuration::Configuration, token: &str, cursor: Option<&str>, limit: Option<i32>, team_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminInviteRequestsDeniedListError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.inviteRequests.denied.list", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn admin_invite_requests_list(configuration: &configuration::Configuration, token: &str, cursor: Option<&str>, limit: Option<i32>, team_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminInviteRequestsListError>> {
...
pub async fn admin_teams_admins_list(configuration: &configuration::Configuration, token: &str, team_id: &str, cursor: Option<&str>, limit: Option<i32>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminTeamsAdminsListError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.teams.admins.list", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn admin_teams_list(configuration: &configuration::Configuration, token: &str, cursor: Option<&str>, limit: Option<i32>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminTeamsListError>> {
...
pub async fn admin_teams_owners_list(configuration: &configuration::Configuration, token: &str, team_id: &str, cursor: Option<&str>, limit: Option<i32>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminTeamsOwnersListError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.teams.owners.list", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn admin_teams_settings_info(configuration: &configuration::Configuration, token: &str, team_id: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminTeamsSettingsInfoError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.teams.settings.info", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn admin_teams_settings_set_default_channels(configuration: &configuration::Configuration, channel_ids: &str, token: &str, team_id: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminTeamsSettingsSetDefaultChannelsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.teams.settings.setDefaultChannels", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn admin_teams_settings_set_description(configuration: &configuration::Configuration, token: &str, team_id: &str, description: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminTeamsSettingsSetDescriptionError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.teams.settings.setDescription", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn admin_teams_settings_set_discoverability(configuration: &configuration::Configuration, token: &str, team_id: &str, discoverability: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminTeamsSettingsSetDiscoverabilityError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.teams.settings.setDiscoverability", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn admin_teams_settings_set_icon(configuration: &configuration::Configuration, token: &str, image_url: &str, team_id: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminTeamsSettingsSetIconError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.teams.settings.setIcon", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn admin_teams_settings_set_name(configuration: &configuration::Configuration, token: &str, team_id: &str, name: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminTeamsSettingsSetNameError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/admin.teams.settings.setName", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn admin_users_assign(configuration: &configuration::Configuration, token: &str, user_id: &str, team_id: &str, channel_ids: Option<&str>, is_ultra_restricted: Option<bool>, is_restricted: Option<bool>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminUsersAssignError>> {
...
pub async fn admin_users_invite(configuration: &configuration::Configuration, token: &str, channel_ids: &str, team_id: &str, email: &str, real_name: Option<&str>, is_ultra_restricted: Option<bool>, custom_message: Option<&str>, is_restricted: Option<bool>, guest_expiration_ts: Option<&str>, resend: Option<bool>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminUsersInviteError>> {
...
pub async fn admin_users_remove(configuration: &configuration::Configuration, token: &str, user_id: &str, team_id: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminUsersRemoveError>> {
...
pub async fn admin_users_set_admin(configuration: &configuration::Configuration, token: &str, user_id: &str, team_id: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminUsersSetAdminError>> {
...
pub async fn admin_users_set_expiration(configuration: &configuration::Configuration, token: &str, expiration_ts: i32, user_id: &str, team_id: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminUsersSetExpirationError>> {
...
pub async fn admin_users_set_owner(configuration: &configuration::Configuration, token: &str, user_id: &str, team_id: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminUsersSetOwnerError>> {
...
pub async fn admin_users_set_regular(configuration: &configuration::Configuration, token: &str, user_id: &str, team_id: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AdminUsersSetRegularError>> {
