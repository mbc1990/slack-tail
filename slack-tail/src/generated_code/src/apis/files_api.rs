...
pub async fn files_comments_delete(configuration: &configuration::Configuration, token: Option<&str>, id: Option<&str>, file: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesCommentsDeleteError>> {
...
/// Deletes a file.
pub async fn files_delete(configuration: &configuration::Configuration, token: Option<&str>, file: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesDeleteError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/files.delete", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn files_info(configuration: &configuration::Configuration, count: Option<&str>, cursor: Option<&str>, token: Option<&str>, limit: Option<i32>, file: Option<&str>, page: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesInfoError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/files.info", configuration.base_path);
...
pub async fn files_list(configuration: &configuration::Configuration, count: Option<&str>, channel: Option<&str>, ts_to: Option<f64>, ts_from: Option<f64>, token: Option<&str>, user: Option<&str>, show_files_hidden_by_limit: Option<bool>, page: Option<&str>, types: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesListError>> {
    ...
    let local_var_uri_str = format!("{}/files.list", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn files_remote_add(configuration: &configuration::Configuration, title: Option<&str>, filetype: Option<&str>, token: Option<&str>, indexable_file_contents: Option<&str>, preview_image: Option<&str>, external_id: Option<&str>, external_url: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesRemoteAddError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/files.remote.add", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn files_remote_info(configuration: &configuration::Configuration, token: Option<&str>, external_id: Option<&str>, file: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesRemoteInfoError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/files.remote.info", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn files_remote_list(configuration: &configuration::Configuration, ts_to: Option<f64>, cursor: Option<&str>, ts_from: Option<f64>, token: Option<&str>, limit: Option<i32>, channel: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesRemoteListError>> {
    ...
    let local_var_uri_str = format!("{}/files.remote.list", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn files_remote_remove(configuration: &configuration::Configuration, token: Option<&str>, external_id: Option<&str>, file: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesRemoteRemoveError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/files.remote.remove", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn files_remote_share(configuration: &configuration::Configuration, channels: Option<&str>, token: Option<&str>, external_id: Option<&str>, file: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesRemoteShareError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/files.remote.share", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn files_remote_update(configuration: &configuration::Configuration, title: Option<&str>, filetype: Option<&str>, token: Option<&str>, file: Option<&str>, indexable_file_contents: Option<&str>, preview_image: Option<&str>, external_id: Option<&str>, external_url: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesRemoteUpdateError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/files.remote.update", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn files_revoke_public_url(configuration: &configuration::Configuration, token: Option<&str>, file: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesRevokePublicUrlError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/files.revokePublicURL", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn files_shared_public_url(configuration: &configuration::Configuration, token: Option<&str>, file: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesSharedPublicUrlError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/files.sharedPublicURL", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn files_upload(configuration: &configuration::Configuration, channels: Option<&str>, title: Option<&str>, initial_comment: Option<&str>, filetype: Option<&str>, filename: Option<&str>, content: Option<&str>, token: Option<&str>, file: Option<&str>, thread_ts: Option<f64>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<FilesUploadError>> {
    ...
    let local_var_uri_str = format!("{}/files.upload", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
