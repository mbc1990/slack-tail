...
pub async fn apps_permissions_info(configuration: &configuration::Configuration, token: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AppsPermissionsInfoError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/apps.permissions.info", configuration.base_path);
...
pub async fn apps_permissions_request(configuration: &configuration::Configuration, scopes: &str, token: &str, trigger_id: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AppsPermissionsRequestError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/apps.permissions.request", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn apps_permissions_resources_list(configuration: &configuration::Configuration, token: &str, cursor: Option<&str>, limit: Option<i32>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AppsPermissionsResourcesListError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/apps.permissions.resources.list", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn apps_permissions_scopes_list(configuration: &configuration::Configuration, token: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AppsPermissionsScopesListError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/apps.permissions.scopes.list", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn apps_uninstall(configuration: &configuration::Configuration, client_secret: Option<&str>, token: Option<&str>, client_id: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<AppsUninstallError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/apps.uninstall", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
