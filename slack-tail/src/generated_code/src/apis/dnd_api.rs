...
pub async fn dnd_set_snooze(configuration: &configuration::Configuration, num_minutes: &str, token: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<DndSetSnoozeError>> {
