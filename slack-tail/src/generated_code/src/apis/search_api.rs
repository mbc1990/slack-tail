...
pub async fn search_messages(configuration: &configuration::Configuration, query: &str, token: &str, sort_dir: Option<&str>, sort: Option<&str>, count: Option<i32>, highlight: Option<bool>, page: Option<i32>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<SearchMessagesError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/search.messages", configuration.base_path);
