...
pub async fn rtm_connect(configuration: &configuration::Configuration, token: &str, presence_sub: Option<bool>, batch_presence_aware: Option<bool>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<RtmConnectError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/rtm.connect", configuration.base_path);
