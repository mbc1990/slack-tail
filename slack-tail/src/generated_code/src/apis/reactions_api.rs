...
pub async fn reactions_add(configuration: &configuration::Configuration, token: &str, timestamp: &str, name: &str, channel: &str) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ReactionsAddError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/reactions.add", configuration.base_path);
...
pub async fn reactions_get(configuration: &configuration::Configuration, token: &str, full: Option<bool>, file_comment: Option<&str>, timestamp: Option<&str>, file: Option<&str>, channel: Option<&str>) -> Result<serde_json::Value, Error<ReactionsGetError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/reactions.get", configuration.base_path);
...
pub async fn reactions_list(configuration: &configuration::Configuration, token: &str, count: Option<i32>, full: Option<bool>, cursor: Option<&str>, limit: Option<i32>, user: Option<&str>, page: Option<i32>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ReactionsListError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/reactions.list", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn reactions_remove(configuration: &configuration::Configuration, token: &str, name: &str, file_comment: Option<&str>, timestamp: Option<&str>, file: Option<&str>, channel: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ReactionsRemoveError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/reactions.remove", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
