...
pub async fn conversations_archive(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsArchiveError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.archive", configuration.base_path);
...
pub async fn conversations_close(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsCloseError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.close", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn conversations_create(configuration: &configuration::Configuration, token: Option<&str>, name: Option<&str>, user_ids: Option<&str>, is_private: Option<bool>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsCreateError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.create", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
    ...
    if let Some(local_var_param_value) = user_ids {
        local_var_form_params.insert("user_ids", local_var_param_value.to_string());
    }
...
pub async fn conversations_history(configuration: &configuration::Configuration, inclusive: Option<bool>, cursor: Option<&str>, token: Option<&str>, limit: Option<i32>, oldest: Option<String>, channel: Option<&str>, latest: Option<f64>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsHistoryError>> {
    ...
    let local_var_uri_str = format!("{}/conversations.history", configuration.base_path);
...
pub async fn conversations_info(configuration: &configuration::Configuration, include_num_members: Option<bool>, token: Option<&str>, channel: Option<&str>, include_locale: Option<bool>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsInfoError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.info", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn conversations_invite(configuration: &configuration::Configuration, token: Option<&str>, users: Option<&str>, channel: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsInviteError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.invite", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn conversations_join(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsJoinError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.join", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn conversations_kick(configuration: &configuration::Configuration, token: Option<&str>, user: Option<&str>, channel: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsKickError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.kick", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn conversations_leave(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsLeaveError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.leave", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn conversations_list(configuration: &configuration::Configuration, cursor: Option<&str>, token: Option<&str>, limit: Option<i32>, exclude_archived: Option<bool>, types: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsListError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.list", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn conversations_members(configuration: &configuration::Configuration, cursor: Option<&str>, token: Option<&str>, limit: Option<i32>, channel: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsMembersError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.members", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn conversations_open(configuration: &configuration::Configuration, token: Option<&str>, return_im: Option<bool>, users: Option<&str>, channel: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsOpenError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.open", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn conversations_rename(configuration: &configuration::Configuration, token: Option<&str>, name: Option<&str>, channel: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsRenameError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.rename", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn conversations_replies(configuration: &configuration::Configuration, inclusive: Option<bool>, ts: Option<f64>, cursor: Option<&str>, token: Option<&str>, limit: Option<i32>, oldest: Option<f64>, channel: Option<&str>, latest: Option<f64>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsRepliesError>> {
    ...
    let local_var_uri_str = format!("{}/conversations.replies", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn conversations_set_purpose(configuration: &configuration::Configuration, token: Option<&str>, purpose: Option<&str>, channel: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsSetPurposeError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.setPurpose", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn conversations_set_topic(configuration: &configuration::Configuration, token: Option<&str>, topic: Option<&str>, channel: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsSetTopicError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.setTopic", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
...
pub async fn conversations_unarchive(configuration: &configuration::Configuration, token: Option<&str>, channel: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<ConversationsUnarchiveError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/conversations.unarchive", configuration.base_path);
    let mut local_var_req_builder = local_var_client.post(local_var_uri_str.as_str());
