...
pub async fn oauth_access(configuration: &configuration::Configuration, code: Option<&str>, token: Option<&str>, redirect_uri: Option<&str>, single_channel: Option<bool>, client_id: Option<&str>, client_secret: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<OauthAccessError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/oauth.access", configuration.base_path);
...
pub async fn oauth_token(configuration: &configuration::Configuration, client_secret: Option<&str>, code: Option<&str>, single_channel: Option<bool>, client_id: Option<&str>, redirect_uri: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<OauthTokenError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/oauth.token", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
/// Exchanges a temporary OAuth verifier code for an access token.
pub async fn oauth_v2_access(configuration: &configuration::Configuration, code: &str, client_secret: Option<&str>, client_id: Option<&str>, redirect_uri: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<OauthV2AccessError>> {
