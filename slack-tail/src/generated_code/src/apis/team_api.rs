...
pub async fn team_access_logs(configuration: &configuration::Configuration, token: &str, count: Option<i32>, page: Option<i32>, before: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<TeamAccessLogsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/team.accessLogs", configuration.base_path);
...
pub async fn team_billable_info(configuration: &configuration::Configuration, token: &str, user: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<TeamBillableInfoError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/team.billableInfo", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn team_info(configuration: &configuration::Configuration, token: &str, team: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<TeamInfoError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/team.info", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn team_integration_logs(configuration: &configuration::Configuration, token: &str, count: Option<i32>, change_type: Option<&str>, app_id: Option<i32>, user: Option<&str>, service_id: Option<i32>, page: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<TeamIntegrationLogsError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/team.integrationLogs", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn team_profile_get(configuration: &configuration::Configuration, token: &str, visibility: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<TeamProfileGetError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/team.profile.get", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
