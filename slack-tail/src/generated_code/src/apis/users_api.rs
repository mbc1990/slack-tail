...
pub async fn users_conversations(configuration: &configuration::Configuration, cursor: Option<&str>, token: Option<&str>, limit: Option<i32>, user: Option<&str>, exclude_archived: Option<bool>, types: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<UsersConversationsError>> {
...
pub async fn users_info(configuration: &configuration::Configuration, token: &str, user: Option<&str>, include_locale: Option<bool>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<UsersInfoError>> {
...
pub async fn users_list(configuration: &configuration::Configuration, cursor: Option<&str>, token: Option<&str>, limit: Option<i32>, include_locale: Option<bool>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<UsersListError>> {
...
pub async fn users_lookup_by_email(configuration: &configuration::Configuration, token: Option<&str>, email: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<UsersLookupByEmailError>> {
...
pub async fn users_profile_get(configuration: &configuration::Configuration, token: Option<&str>, include_labels: Option<bool>, user: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<UsersProfileGetError>> {
...
pub async fn users_profile_set(configuration: &configuration::Configuration, token: Option<&str>, profile: Option<&str>, user: Option<&str>, value: Option<&str>, name: Option<&str>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<UsersProfileSetError>> {
...
pub async fn users_set_photo(configuration: &configuration::Configuration, image: Option<&str>, crop_w: Option<i32>, token: Option<&str>, crop_y: Option<i32>, crop_x: Option<i32>) -> Result<::std::collections::HashMap<String, serde_json::Value>, Error<UsersSetPhotoError>> {
