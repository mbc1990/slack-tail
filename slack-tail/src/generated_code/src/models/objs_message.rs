...
pub struct ObjsMessage {
    ...
    pub replies: Option<Vec<crate::models::ObjsMessageReplies>>,
    ...
    pub user_profile: Option<crate::models::ObjsUserProfileShort>,
